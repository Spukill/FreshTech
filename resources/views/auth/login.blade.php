    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="text-center mb-4">
                <h2>Login to FreshTech</h2>
                <p class="text-muted">Welcome back! Please sign in to your account.</p>
            </div>
            <form method="POST" action="{{ route('login') }}" class="p-4 border rounded log">
                @csrf
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <button type="submit" class="btn btn-primary btn-sm botao">Login</button>
                        <a class="btn btn-outline-primary ms-2 btn-sm botao1" href="{{ route('register') }}">Register</a>
                    </div>
                    <div class="text-end">
